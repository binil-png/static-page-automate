...
function pickColorPalette() {
  lastPaletteIndex = (lastPaletteIndex + 1) % COLOR_PALETTES.length;
  return COLOR_PALETTES[lastPaletteIndex];
}
...
This generation MUST use the ${family} color palette only. Do not use teal unless this palette is teal.
...
- Testimonials: only when extra pages were purchased and reviews or entered testimonials exist; white rounded-2xl cards, ${family} quote mark, ${family} stars when a rating exists, author row with initial avatar, slate quote text. Omit the section otherwise.
...
- Follow the visual style guide in the brief: Tailwind CDN, Lucide icons, Plus Jakarta Sans, ${palette.family} clinic layout (top bar, sticky header, gradient hero, about split, service cards, contact columns). Use ${palette.family} classes and these hex accents: ${palette.deep}, ${palette.mid}, ${palette.bright}. Do not use teal unless this palette is teal.
